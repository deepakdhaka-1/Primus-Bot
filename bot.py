...
class Primuslabs:
    ...
    def generate_username(self):
        first_parts = [
            "0xdeepak", "andi", "rama", "dika", "nino", "alfa", "bima", "zaki", "aryan", "galih",
            "dewa", "luki", "fajar", "chirag", "taufik", "ilham", "riko", "arif", "dian", "ivan",
            "fikri", "adit", "udin", "eko", "kiki", "miss", "faiz", "farhan", "syam", "rizky",
        ...
        second_parts = [
            ...
            "tech", "ops", "hub", "net", "app", "xyz", "zullie", "cloud", "main", "lab", "studio",
            "dhaka", "zone", "world", "offcl", "web", "site", "desk", "data", "sys", "byte", "bit",
